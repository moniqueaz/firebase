...
function showError(prefix, error) {
  ...
  switch (error.code) {
    case 'auth/invalid-email': console.error(prefix + ' ' + 'E-mail inválido!')
      break;
    case 'auth/wrong-password': console.error(prefix + ' ' + 'Senha inválida!')
      break;
    case 'auth/weak-password': console.error(prefix + ' ' + 'Senha deve ter ao menos 6 caracteres!')
      break;
    case 'auth/email-already-in-use': console.error(prefix + ' ' + 'E-mail já está em uso por outra conta!')
      break;
    case 'auth/popup-closed-by-user': console.error(prefix + ' ' + 'O popup de autenticação foi fechado antes da operação ser concluída!')
      break;
    case 'storage/canceled':
      break;
    case 'storage/unauthorized': console.error(prefix + ' ' + 'Falha ao acessar o Cloud Storage!')
      break;

    default: console.error(prefix + ' ' + error.message)
  }
}
